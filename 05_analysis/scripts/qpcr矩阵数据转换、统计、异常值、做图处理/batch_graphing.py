...
OUT_DIR = Path("/Users/gongbaoming/Library/CloudStorage/OneDrive-个人/发育生物所/博士课题/EphB1/04_data/processed/qpcr/batch_group")
...
if "batch_id" not in df.columns:
    raise ValueError("❌ 数据缺少 batch_id 列。")
df["exp_batch"] = df["batch_id"].astype(str)
