...
OUT_DIR = Path("/Users/gongbaoming/Library/CloudStorage/OneDrive-个人/发育生物所/博士课题/EphB1/04_data/processed/qpcr/experiment_group")
...
# 以 experiment_id 作为绘图单位
if "experiment_id" not in df.columns:
    raise ValueError("❌ 数据缺少 experiment_id 列。")
df["exp_batch"] = df["experiment_id"].astype(str)
